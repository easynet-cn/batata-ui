...
export {}
declare global {
  const ApiError: typeof import('./utils/error').ApiError
  ...
  const toast: typeof import('./utils/error').toast
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    readonly ApiError: UnwrapRef<(typeof import('./utils/error'))['ApiError']>
    ...
    readonly toast: UnwrapRef<(typeof import('./utils/error'))['toast']>
